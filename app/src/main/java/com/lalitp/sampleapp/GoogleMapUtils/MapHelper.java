package com.lalitp.sampleapp.GoogleMapUtils;
...
import static com.lalitp.sampleapp.GoogleMapUtils.MapTypes.NONE;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.AZURE;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.BLUE;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.CYAN;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.GREEN;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.MAGENTA;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.ORANGE;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.RED;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.ROSE;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.VIOLET;
import static com.lalitp.sampleapp.GoogleMapUtils.MarkerColors.YELLOW;
...
public class MapHelper {
    ...
    public Marker addMarker(double latitude, double longitude, String title,
                            String snippet, boolean playAnimation, int drawable) {
        ...
        Log.d(LOG_TAG, "addMarker " + latitude + " " + longitude);

        return googleMap.addMarker(markerOptions);
    }

    public Marker addMarker(double latitude, double longitude, String title,
                            String snippet, boolean playAnimation, BitmapDescriptor icon) {
        MarkerOptions markerOptions = new MarkerOptions()
                .position(new LatLng(latitude, longitude)).title(title)
                .icon(icon)
                .snippet(snippet);
    ...
    public Marker addMarker(double latitude, double longitude, String title,
        ...
        return addMarker(latitude, longitude, title, snippet, playAnimation, R.drawable.ic_menu_white_24dp);
    }
    ...
    public Marker addMarker(double latitude, double longitude, String title,
        ...
        this.moveCameraToLocation = moveCameraToLocation;
        return addMarker(latitude, latitude, title, snippet, playAnimation, R.drawable.ic_menu_white_24dp);
    }
...
*/
    ...
    public Circle drawCircularRegion(LatLng LatLng, int radius,
       ...
       /* googleMap.addMarker(new MarkerOptions().position(LatLng)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_location_on_deep_orange_500_24dp)));
*/
    ...
    public void zoomToFitMarkers(Marker... markers) {
        ...
        for (Marker m : markers) {
            Log.d(LOG_TAG, "zoomToFitLatLongs " + m.getPosition().latitude + " " + m.getPosition().longitude);
     ...
     */
    public void zoomToFitLatLongs(List<LatLng> latlng) {
        ...
        LatLngBounds.Builder b = new LatLngBounds.Builder();
        for (LatLng l : latlng) {
            Log.d(LOG_TAG, "zoomToFitLatLongs " + l.latitude + " " + l.longitude);
            b.include(l);
        }
        Log.d(LOG_TAG, "zoomToFitLatLongs" + padding);
        LatLngBounds bounds = b.build();
        CameraUpdate cu = CameraUpdateFactory
                .newLatLngBounds(bounds, width, height, padding);
        ...
        for (int i = 0; i < markers.length; i++) {
            ...
            if (drawMarkers)
                markers[i] = addMarker(markers[i].getPosition().latitude,
                        ...
                        markers[i].getTitle(), markers[i].getSnippet(), false, R.drawable.ic_menu_white_24dp);
        }
